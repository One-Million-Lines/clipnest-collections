...
export function PlatformIcon({ platform, className, size = "md" }: PlatformIconProps) {
  ...
  switch (platform) {
    ...
    case "instagram":
      return (
        <div className={cn(baseClasses, "bg-gradient-to-tr from-[hsl(37,91%,55%)] via-[hsl(329,70%,52%)] to-[hsl(260,60%,55%)]", className)}>
          <svg viewBox="0 0 24 24" className={cn(iconSize, "fill-current")}>
    ...
    default:
      return (
        <div className={cn(baseClasses, "bg-muted-foreground", className)}>
          <svg viewBox="0 0 24 24" className={cn(iconSize, "fill-current")}>
